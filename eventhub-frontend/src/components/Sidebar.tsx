...
export const Sidebar = ({ role }: SidebarProps) => {
  ...
  const userLinks = [
    ...
    { to: '/upcoming-events', label: 'Upcoming Events', icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  const adminLinks = [
    ...
    { to: '/admin/events', label: 'Events Management', icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
      </svg>
    )},
    ...
    <>
        ...
        {links.map((link) => {
          ...
          return (
            <Link
              ...
              className={`flex items-center px-4 py-3 rounded-custom transition-colors ${
                isActive
      ...
      <div className="p-4">
        <button
          ...
          className="flex items-center w-full px-4 py-3 text-gray-700 hover:bg-gray-100 rounded-custom transition-colors"
        >
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {mobileOpen && (
        <>
          <div
            ...
            onClick={() => setMobileOpen(false)}
          />
          <aside className="lg:hidden fixed inset-y-0 left-0 w-64 bg-white z-50 flex flex-col shadow-xl">
            <SidebarContent />
          </aside>
        </>
      )}
